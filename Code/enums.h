...
enum eRemoteMessageType : std::int64_t
{
	RemoteMessageSpectating = 730884144,
	RemoteMessageIdleKick = 244175981,
	RemoteMessagePsycho = -1670647875,
	RemoteMessageGoonRemove = 2144391549,
	RemoteMessageGoonLeave = 1679370544,
	RemoteMessageGoonJoin = 1180859185
};
static constexpr std::uintptr_t RemoteEventBlockBase = 1382674;
enum eRemoteEventBlockGlobals : std::uintptr_t
{
	RemoteEventBlockGlobalKick = 595, //
	RemoteEventBlockGlobalCEOKick = 536,//
	RemoteEventBlockGlobalCEOBan = 558,//
	RemoteEventBlockGlobalOTR = 492,//
	RemoteEventBlockGlobalBlackScreen = 499,//Same as tp
	RemoteEventBlockGlobalSendToJob = 677, //
	RemoteEventBlockGlobalTeleport = 499, //
	RemoteEventBlockGlobalSoundSpam = 33, //
	RemoteEventBlockGlobalTransactionError = 350, //
	RemoteEventBlockGlobalWeather = 17, //
	RemoteEventBlockGlobalBounty = 67,
	RemoteEventBlockGlobalClearWantedLevel = 490, //
	RemoteEventBlockGlobalInsuranceFraud = 433//
};
enum ExplosionTypes
{
	EXPLOSION_GRENADE,
...
enum eFrameFlags : std::uint32_t
{
	...
	eFrameFlagUnknown13 = 268435456u,
};
