...
#define OFFSET_PLAYER_INFO_WANTED				0x0848			//wanted level; DWORD
...
//vehicle offsets
#define OFFSET_VEHICLE_HEALTH						0x87C			//vehicle health; 0.f-1000.f
...
#define OFFSET_VEHICLE_BULLETPROOF_TIRES			0x8B3			//btBulletproofTires;  (btBulletproofTires & 0x20) ? true : false
#define OFFSET_VEHICLE_ALARM_LENGTH					0xA18			//dwCarAlarmLength
//#define OFFSET_VEHICLE_OPENABLE_DOORS				0xB30			//btOpenableDoors
#define OFFSET_VEHICLE_GRAVITY						0xBCC			//fGravity
#define OFFSET_INF_ROCKET_BOOST						0x322
...
#define OFFSET_WEAPON_RECOIL            0x2D8           //float set to 0
#define OFFSET_WEAPON_RECOIL_FP         0x2CC           //DWORD set to 0
#define OFFSET_WEAPON_MODEL_HASH        0x14
#define OFFSET_WEAPON_NAME_HASH         0x10
