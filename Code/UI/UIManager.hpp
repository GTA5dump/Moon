...
namespace Big::UserInterface
{
	...
	public:
		...
		float m_PosN = 0.25f;
		float m_PosO = 2.0f;
		float m_ToggleX = 0.0f;
		float m_PosY = 0.1f;
		float m_ToggleY = 0.0f;
		float m_Width = 0.24f;
		...
		// Header
		float m_HeaderHeight = 0.085f; //float m_HeaderHeight = 0.1f;
		bool m_HeaderText = true;
		float m_HeaderTextSize = 1.f;
		Font m_HeaderFont = Font::Pricedown; //Font m_HeaderFont = Font::HouseScript;
		...
		Color m_HeaderGradientColorLeft{ 225, 50, 190, 255 };
		Color m_HeaderGradientColorRight{ 240, 132, 190, 255 };
		/*Color m_HeaderGradientColorLeft{ 100, 134, 255, 255 };
		Color m_HeaderGradientColorRight{ 200, 94, 100, 255 };*/

		// Submenu bar
		float m_SubmenuBarHeight = 0.036f; //float m_SubmenuBarHeight = 0.04f;
		float m_SubmenuBarTextSize = 0.37f; //float m_SubmenuBarTextSize = 0.37f;
		Font m_SubmenuBarFont = Font::ChaletLondon;
		float m_SubmenuBarPadding = 2.1f;
		Color m_SubmenuBarBackgroundColor{ 0, 0, 0, 255 }; //Color m_SubmenuBarBackgroundColor{ 0, 0, 0, 220 };
		Color m_SubmenuBarTextColor{ 255, 255, 255, 255 };

		// Options
		float m_OptionHeight = 0.035f; //0.04f
		float m_OptionTextSize = 0.29f; //0.32f
		...
		Color m_OptionUnselectedBackgroundColor{ 0, 0, 0, 150 };

		// Footer
		float m_FooterHeight = 0.031f; //float m_FooterHeight = 0.04f;
		float m_FooterSpriteSize = 0.036f; //float m_FooterSpriteSize = 0.025f;
		Color m_FooterBackgroundColor{ 10, 10, 10, 255 }; //Color m_FooterBackgroundColor{ 10, 10, 10, 200 };
		Color m_FooterSpriteColor{ 255, 255, 255, 255 };

		// Description
		float m_DescriptionHeightPadding = 0.000f;
