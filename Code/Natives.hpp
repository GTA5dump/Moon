...
{	
	...
	typedef __int64(__fastcall* GetLocalPlayerAddress_t)();
	static __int64 GetLocalPlayerAddress() { static GetLocalPlayerAddress_t oGetLocalPlayerAddress = (GetLocalPlayerAddress_t)(Memory::pattern("48 8B 05 ?? ?? ?? ?? 48 8B 40 08 C3").count(1).get(0).get<void>()); return oGetLocalPlayerAddress(); }

	static Ped GET_PLAYER_PED(Player player) { return invoke<Ped>(0x43A96C31C68491C0, player); } // 0x43A66C31C68491C0 0x6E31E993
	typedef Entity(__fastcall* tptr_to_handle)(void* entity);
	static Entity ptr_to_handle(void* entity) { static tptr_to_handle optr_to_handle = (tptr_to_handle)(Memory::pattern("48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 20 8B 15 ? ? ? ? 48 8B F9 48 83 C1 10 33 DB").count(1).get(0).get<void>()); return optr_to_handle(entity); }
	...
	static void SET_PLAYER_MODEL(Player player, Hash model) { invoke<Void>(0xa1cadd00108836, player, model); } // 0x00A1CADD00108836 0x774A4C54
	...
	typedef int(__fastcall* tGET_PLAYER_MAX_ARMOUR)(Player player);
	static int GET_PLAYER_MAX_ARMOUR(Player player) { static tGET_PLAYER_MAX_ARMOUR oGET_PLAYER_MAX_ARMOUR = (tGET_PLAYER_MAX_ARMOUR)(Memory::pattern("40 53 48 83 EC 20 33 DB 38 1D ? ? ? ? 74 1C").count(1).get(0).get<void>()); return oGET_PLAYER_MAX_ARMOUR(player); }
	...
	static int GIVE_ACHIEVEMENT_TO_PLAYER(int achievement1) { return invoke<int>(0xBEC7076D64130195, achievement1); } // 0xBEC7076D64130195 0x822BC992
...
namespace ENTITY
{
	...
	typedef Entity(__fastcall* tGET_ENTITY_ATTACHED_TO)(Entity entity);
	static Entity GET_ENTITY_ATTACHED_TO(Entity entity) { static tGET_ENTITY_ATTACHED_TO oGET_ENTITY_ATTACHED_TO = (tGET_ENTITY_ATTACHED_TO)(Memory::pattern("40 53 48 83 EC 20 E8 ? ? ? ? 48 8B D8 48 85 C0 74 19 4C 8B 00 8B 15 ? ? ? ? 48 8B C8 41 FF 50 08 84 C0 74 05 48 8B C3 EB 02 33 C0 48 83 C4 20 5B C3 40 53 48 83 EC 20 E8 ? ? ? ? 48 8B D8").count(1).get(0).get<void>()); return oGET_ENTITY_ATTACHED_TO(entity); }
	...
	typedef BOOL(__fastcall* tSET_ENTITY_COLLISION)(Entity entity, BOOL toggle, BOOL keepPhysics);
	static BOOL SET_ENTITY_COLLISION(Entity entity, BOOL toggle, BOOL keepPhysics) { static tSET_ENTITY_COLLISION oSET_ENTITY_COLLISION = (tSET_ENTITY_COLLISION)(Memory::pattern("48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC 20 41 8A F1 41 8A E8 40 8A FA").count(1).get(0).get<void>()); return oSET_ENTITY_COLLISION(entity, toggle, keepPhysics); }
	...
	typedef void(__fastcall* tSET_ENTITY_PROOFS)(Entity entity, BOOL bulletProof, BOOL fireProof, BOOL explosionProof, BOOL collisionProof, BOOL meleeProof, BOOL p6, BOOL p7, BOOL drownProof);
	static void SET_ENTITY_PROOFS(Entity entity, BOOL bulletProof, BOOL fireProof, BOOL explosionProof, BOOL collisionProof, BOOL meleeProof, BOOL p6, BOOL p7, BOOL drownProof) { static tSET_ENTITY_PROOFS oSET_ENTITY_PROOFS = (tSET_ENTITY_PROOFS)(Memory::pattern("48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 20 41 8A D9 41 8A F8").count(1).get(0).get<void>()); return oSET_ENTITY_PROOFS(entity, bulletProof, fireProof, explosionProof, collisionProof, meleeProof, p6, p7, drownProof); }
...
namespace PED
{
	...
	static void SET_PED_COMPONENT_VARIATION(Ped ped, int componentId, int drawableId, int textureId, int paletteId) { invoke<Void>(0x262B14F48D29DE80, ped, componentId, drawableId, textureId, paletteId); } // 0x262B14F48D29DE80 0xD4F7B05C  48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC 50 41 8B F9
																																																			  //typedef void(__fastcall* tSET_PED_COMPONENT_VARIATION)(Ped ped, int componentId, int drawableId, int textureId, int paletteId);
																																																			  //static void SET_PED_COMPONENT_VARIATION(Ped ped, int componentId, int drawableId, int textureId, int paletteId) { static tSET_PED_COMPONENT_VARIATION oSET_PED_COMPONENT_VARIATION = (tSET_PED_COMPONENT_VARIATION)(Memory::pattern("48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC 50 41 8B F9").count(1).get(0).get<void>()); return oSET_PED_COMPONENT_VARIATION(ped, componentId, drawableId, textureId, paletteId); }
	...
	typedef void(__fastcall* tCLEAR_PED_BLOOD_DAMAGE)(Ped ped, char* damagePack, float damage, float mult);
	static void CLEAR_PED_BLOOD_DAMAGE(Ped ped, char* damagePack, float damage, float mult) { static tCLEAR_PED_BLOOD_DAMAGE oCLEAR_PED_BLOOD_DAMAGE = (tCLEAR_PED_BLOOD_DAMAGE)(Memory::pattern("40 53 48 83 EC 20 8A 91 ? ? ? ? 48 8B D9 80 FA FF 74 51").count(1).get(0).get<void>()); return oCLEAR_PED_BLOOD_DAMAGE(ped, damagePack, damage, mult); }
...
namespace VEHICLE
{
	...
	//static Vehicle CREATE_VEHICLESteam(Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL p6) { return invoke<Vehicle>(0xAF35D0D2583051B0, modelHash, x, y, z, heading, isNetwork, p6); } // 0xAF35D0D2583051B0 0xDD75460A
	...
	static void SET_VEHICLE_TYRE_FIXED(Vehicle vehicle, int tyreIndex) { invoke<Void>(0x6E13FC662B882D1D, vehicle, tyreIndex); } // 0x6E13FC662B882D1D 0xA42EFA6B
																																 //static void SET_VEHICLE_NUMBER_PLATE_TEXTSteam(Vehicle vehicle, char* plateText) { invoke<Void>(0x95A88F0B409CDA47, vehicle, plateText); } // 0x95A88F0B409CDA47 0x400F9556
	typedef void(__fastcall* tSET_VEHICLE_NUMBER_PLATE_TEXT)(Vehicle vehicle, char* plateText);
	static void SET_VEHICLE_NUMBER_PLATE_TEXT(Vehicle vehicle, char* plateText) { static tSET_VEHICLE_NUMBER_PLATE_TEXT oSET_VEHICLE_NUMBER_PLATE_TEXT = (tSET_VEHICLE_NUMBER_PLATE_TEXT)(Memory::pattern("40 53 48 83 EC 20 48 8B DA E8 ? ? ? ? 48 85 C0 74 10 48 8B 48 48").count(1).get(0).get<void>()); return oSET_VEHICLE_NUMBER_PLATE_TEXT(vehicle, plateText); }
	...
	typedef BOOL(__fastcall* tIS_THIS_MODEL_A_PLANE)(Hash model);
	static BOOL IS_THIS_MODEL_A_PLANE(Hash model) { static tIS_THIS_MODEL_A_PLANE oIS_THIS_MODEL_A_PLANE = (tIS_THIS_MODEL_A_PLANE)(Memory::pattern("40 53 48 83 EC 20 48 8D 54 24 ? 33 DB C7 44 24 ? ? ? ? ? E8 ? ? ? ? 48 8B C8 48 85 C0 74 1D 8A 80 ? ? ? ? 24 1F 3C 05 75 11 BA").count(1).get(0).get<void>()); return oIS_THIS_MODEL_A_PLANE(model); }
	//static BOOL IS_THIS_MODEL_A_HELI(Hash model) { return invoke<BOOL>(0xDCE4334788AF94EA, model); } // 0xDCE4334788AF94EA 0x8AF7F568
	typedef BOOL(__fastcall* tIS_THIS_MODEL_A_HELI)(Hash model);
	static BOOL IS_THIS_MODEL_A_HELI(Hash model) { static tIS_THIS_MODEL_A_HELI oIS_THIS_MODEL_A_HELI = (tIS_THIS_MODEL_A_HELI)(Memory::pattern("40 53 48 83 EC 20 48 8D 54 24 ? 33 DB C7 44 24 ? ? ? ? ? E8 ? ? ? ? 48 8B C8 48 85 C0 74 1E 8A 80 ? ? ? ? 24 1F 3C 05 75 12 83 B9 ? ? ? ? 08").count(1).get(0).get<void>()); return oIS_THIS_MODEL_A_HELI(model); }
	...
	typedef void(__fastcall* tSET_HELI_BLADES_FULL_SPEED)(Vehicle vehicle);
	static void SET_HELI_BLADES_FULL_SPEED(Vehicle vehicle) { static tSET_HELI_BLADES_FULL_SPEED oSET_HELI_BLADES_FULL_SPEED = (tSET_HELI_BLADES_FULL_SPEED)(Memory::pattern("40 53 48 83 EC 30 0F 29 74 24 ? 0F 28 F1 0F 2F 35").count(1).get(0).get<void>()); return oSET_HELI_BLADES_FULL_SPEED(vehicle); }
	...
	typedef void(__fastcall* tSET_VEHICLE_ENGINE_ON)(Vehicle vehicle, BOOL value, BOOL instantly, BOOL otherwise);
	static void SET_VEHICLE_ENGINE_ON(Vehicle vehicle, BOOL value, BOOL instantly, BOOL otherwise) { static tSET_VEHICLE_ENGINE_ON oSET_VEHICLE_ENGINE_ON = (tSET_VEHICLE_ENGINE_ON)(Memory::pattern("48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC 20 41 8A E9 41 8A F8").count(1).get(0).get<void>()); return oSET_VEHICLE_ENGINE_ON(vehicle, value, instantly, otherwise); }
	...
	typedef void(__fastcall* tSET_VEHICLE_UNDRIVEABLE)(Vehicle vehicle, BOOL toggle);
	static void SET_VEHICLE_UNDRIVEABLE(Vehicle vehicle, BOOL toggle) { static tSET_VEHICLE_UNDRIVEABLE oSET_VEHICLE_UNDRIVEABLE = (tSET_VEHICLE_UNDRIVEABLE)(Memory::pattern("40 53 48 83 EC 20 8A DA E8 ? ? ? ? 48 85 C0 74 20 84 DB").count(1).get(0).get<void>()); return oSET_VEHICLE_UNDRIVEABLE(vehicle, toggle); }
	...
	typedef BOOL(__fastcall* tIS_VEHICLE_DRIVEABLE)(Vehicle vehicle, BOOL p1);
	static BOOL IS_VEHICLE_DRIVEABLE(Vehicle vehicle, BOOL p1) { static tIS_VEHICLE_DRIVEABLE oIS_VEHICLE_DRIVEABLE = (tIS_VEHICLE_DRIVEABLE)(Memory::pattern("48 89 5C 24 ? 57 48 83 EC 20 40 8A FA E8 ? ? ? ? 48 8B D8 48 85 C0 74 36").count(1).get(0).get<void>()); return oIS_VEHICLE_DRIVEABLE(vehicle, p1); }
	...
	typedef char* (__fastcall* tGET_DISPLAY_NAME_FROM_VEHICLE_MODEL)(Hash modelHash);
	static char* GET_DISPLAY_NAME_FROM_VEHICLE_MODEL(Hash modelHash) { static tGET_DISPLAY_NAME_FROM_VEHICLE_MODEL oGET_DISPLAY_NAME_FROM_VEHICLE_MODEL = (tGET_DISPLAY_NAME_FROM_VEHICLE_MODEL)(Memory::pattern("48 83 EC 28 48 8D 54 24 ? C7 44 24 ? ? ? ? ? E8 ? ? ? ? 48 85 C0 74 16").count(1).get(0).get<void>()); return oGET_DISPLAY_NAME_FROM_VEHICLE_MODEL(modelHash); }
	...
	static BOOL _IS_VEHICLE_MOD_LOAD_DONE(Vehicle vehicle) { return invoke<BOOL>(0x9A83F5F9963775EF, vehicle); } // 0x9A83F5F9963775EF 0x112D637A
																												 //static void SET_VEHICLE_MODSteam(Vehicle vehicle, int modType, int modIndex, BOOL customTires) { invoke<Void>(0x6AF0636DDEDCB6DD, vehicle, modType, modIndex, customTires); } // 0x6AF0636DDEDCB6DD 0xB52E5ED5
	typedef BOOL(__fastcall* tSET_VEHICLE_MOD)(Vehicle vehicle, int modType, int modIndex, BOOL customTires);
	static BOOL SET_VEHICLE_MOD(Vehicle vehicle, int modType, int modIndex, BOOL customTires) { static tSET_VEHICLE_MOD oSET_VEHICLE_MOD = (tSET_VEHICLE_MOD)(Memory::pattern("48 89 5C 24 ? 48 89 6C 24 ? 56 57 41 56 48 83 EC 30 41 8A E9").count(1).get(0).get<void>()); return oSET_VEHICLE_MOD(vehicle, modType, modIndex, customTires); }
	...
	typedef BOOL(__fastcall* tTOGGLE_VEHICLE_MOD)(Vehicle vehicle, int modType, BOOL toggle);
	static BOOL TOGGLE_VEHICLE_MOD(Vehicle vehicle, int modType, BOOL toggle) { static tTOGGLE_VEHICLE_MOD oTOGGLE_VEHICLE_MOD = (tTOGGLE_VEHICLE_MOD)(Memory::pattern("48 89 5C 24 ? 57 48 83 EC 20 41 8A F8 8B DA 83 FA 0A").count(1).get(0).get<void>()); return oTOGGLE_VEHICLE_MOD(vehicle, modType, toggle); }
	...
	typedef Vehicle(__fastcall* tGET_VEHICLE_WINDOW_TINT)(Vehicle vehicle);
	static Vehicle GET_VEHICLE_WINDOW_TINT(Vehicle vehicle) { static tGET_VEHICLE_WINDOW_TINT oGET_VEHICLE_WINDOW_TINT = (tGET_VEHICLE_WINDOW_TINT)(Memory::pattern("48 83 EC 28 E8 ? ? ? ? 48 85 C0 74 14 48 8B 40 48").count(1).get(0).get<void>()); return oGET_VEHICLE_WINDOW_TINT(vehicle); }
...
namespace OBJECT
{
	//static Object CREATE_OBJECT(Hash model, float x, float y, float z, bool offset, int unk0, int unk1, Object* out, bool isNetworked, bool unk2, bool dynamic) { return invoke<Object>(0x509D5878EB39E842, model, x, y, z, offset, unk0, unk1, out, isNetworked, unk2, dynamic); } // 0x509D5878EB39E842 0x2F7AA05C
	...
	//typedef Pickup(__fastcall* tCREATE_AMBIENT_PICKUP)(DWORD pickupHash, float x, float y, float z, int unk0, int value, DWORD modelHash, bool unk1, bool unk2);
	//static Pickup CREATE_AMBIENT_PICKUP(DWORD pickupHash, float x, float y, float z, int unk0, int value, DWORD modelHash, bool unk1, bool unk2) { static tCREATE_AMBIENT_PICKUP oCREATE_AMBIENT_PICKUP = (tCREATE_AMBIENT_PICKUP)(Memory::pattern("48 8B C4 48 89 58 10 48 89 70 18 48 89 78 20 55 41 54 41 55 41 56 41 57 48 8D 68 C1 48 81 EC ? ? ? ? 45 8B F9 41 8B F0 4C 8B EA E8 ? ? ? ? 0F B7 0D ? ? ? ? 33 FF 44 8B C7 44 8B D7 44 8B E0 85 C9 7E 1C 48 8B 1D ? ? ? ?").count(1).get(0).get<void>()); return oCREATE_AMBIENT_PICKUP(pickupHash, x,y,z, unk0, value, modelHash, unk1, unk2); }
	...
	static Pickup CREATE_AMBIENT_PICKUP(DWORD pickupHash, float x, float y, float z, int unk0, int value, DWORD modelHash, bool unk1, bool unk2) {
		...
		return CREATE_AMBIENT_PICKUPP(pickupHash, coords, unk0, value, modelHash, unk1, unk2);
																																																														 ...
																																																														 //48 89 5C 24 ? 48 8D 64 24 ? 48 83 EC 40 48 8B 41 10 48 89 4C 24 ? 			 DWORD pickupHash, float x, float y, float z, int unk0, int value, DWORD modelHash, bool unk1, bool unk2																																																				 //	typedef Pickup(__fastcall* tCREATE_AMBIENT_PICKUP)(DWORD pickupHash, Vector3* pos, int unk0, int value, DWORD modelHash, bool unk1, bool unk2);
	static void _PED_DEATH_DROP(float x, float y, float z, int amount) { invoke<Void>(14311548939713375618, x, y, z, amount, 1, -1666779307); }
...
namespace AI
{
	...
	typedef BOOL(__fastcall* tTASK_PLAY_ANIM)(Ped ped, char* animDictionary, char* animationName, float speed, float speedMultiplier, int duration, int flag, float playbackRate, BOOL lockX, BOOL lockY, BOOL lockZ);
	static BOOL TASK_PLAY_ANIM(Ped ped, char* animDictionary, char* animationName, float speed, float speedMultiplier, int duration, int flag, float playbackRate, BOOL lockX, BOOL lockY, BOOL lockZ) { static tTASK_PLAY_ANIM oTASK_PLAY_ANIM = (tTASK_PLAY_ANIM)(Memory::pattern("48 81 EC ? ? ? ? 44 8B 8C 24").count(1).get(0).get<void>()); return oTASK_PLAY_ANIM(ped, animDictionary, animationName, speed, speedMultiplier, duration, flag, playbackRate, lockX, lockY, lockZ); }
	...
	typedef void(__fastcall* tCLEAR_PED_TASKS_IMMEDIATELY)(Ped ped);
	static void CLEAR_PED_TASKS_IMMEDIATELY(Ped ped) { static tCLEAR_PED_TASKS_IMMEDIATELY oCLEAR_PED_TASKS_IMMEDIATELY = (tCLEAR_PED_TASKS_IMMEDIATELY)(Memory::pattern("40 53 48 83 EC 30 E8 ? ? ? ? 48 8B D8 48 85 C0 0F 84").count(1).get(0).get<void>()); return oCLEAR_PED_TASKS_IMMEDIATELY(ped); }
...
namespace GAMEPLAY
{
	...
	static void SET_OVERRIDE_WEATHER(char* weatherType) { invoke<Void>(0xA43D5C6FE51ADBEF, weatherType); } // 0xA43D5C6FE51ADBEF 0xD9082BB5
																										   //typedef void(__fastcall* tSET_OVERRIDE_WEATHER)(char* weatherType);
																										   //static void SET_OVERRIDE_WEATHER(char* weatherType) { static tSET_OVERRIDE_WEATHER oSET_OVERRIDE_WEATHER = (tSET_OVERRIDE_WEATHER)(Memory::pattern("48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 20 8B 1D ? ? ? ? 8B F1").count(1).get(0).get<void>()); return oSET_OVERRIDE_WEATHER(weatherType); }
...
namespace AUDIO
{
	...
	static void PLAY_SOUND_FROM_COORD(int soundId, char* audioName, Vector3 coords, char* audioRef, BOOL p6, int range, BOOL p8) { invoke<Void>(0x8D8686B622B88120, soundId, audioName, coords, audioRef, p6, range, p8); } // 0x8D8686B622B88120 0xCAD3E2D5
	...
	typedef void(__fastcall* tSET_MOBILE_RADIO_ENABLED_DURING_GAMEPLAY)(BOOL Toggle);
	static void SET_MOBILE_RADIO_ENABLED_DURING_GAMEPLAY(BOOL Toggle) { static tSET_MOBILE_RADIO_ENABLED_DURING_GAMEPLAY oSET_MOBILE_RADIO_ENABLED_DURING_GAMEPLAY = (tSET_MOBILE_RADIO_ENABLED_DURING_GAMEPLAY)(Memory::pattern("40 53 48 83 EC 20 8A D9 48 8D 0D ? ? ? ? E8 ? ? ? ? 48 8D 0D ? ? ? ? 8B D0 E8 ? ? ? ? 48 85 C0 74 10").count(1).get(0).get<void>()); return oSET_MOBILE_RADIO_ENABLED_DURING_GAMEPLAY(Toggle); }
	...
	static void SPECIAL_FRONTEND_EQUAL(Vector3 coords) { invoke<Void>(0x21442F412E8DE56B, coords); } // 0x21442F412E8DE56B 0x6FE5D865
...
namespace WEAPON
{
	...
	static void SET_CURRENT_PED_WEAPON(Ped ped, Hash weaponHash, BOOL equipNow) { invoke<Void>(0xADF692B254977C0C, ped, weaponHash, equipNow); } // 0xADF692B254977C0C 0xB8278882
																																				 //static BOOL GET_CURRENT_PED_WEAPONSteam(Ped ped, Hash* weaponHash, BOOL p2) { return invoke<BOOL>(0x3A87E44BB9A01D54, ped, weaponHash, p2); } // 0x3A87E44BB9A01D54 0xB0237302
	...
	static void GIVE_WEAPON_TO_PED(Ped ped, Hash weaponHash, int ammoCount, BOOL isHidden, BOOL equipNow) { invoke<Void>(0xBF0FD6E56C964FCB, ped, weaponHash, ammoCount, isHidden, equipNow); } // 0xBF0FD6E56C964FCB 0xC4D88A85
																																																//static void GIVE_DELAYED_WEAPON_TO_PEDSteam(Ped ped, Hash weaponHash, int ammoCount, BOOL equipNow) { invoke<Void>(0xB282DC6EBD803C75, ped, weaponHash, ammoCount, equipNow); } // 0xB282DC6EBD803C75 0x5868D20D
	...
	//typedef BOOL(__fastcall* tGET_PED_LAST_WEAPON_IMPACT_COORD)(Ped ped, float* coords);
	//static BOOL GET_PED_LAST_WEAPON_IMPACT_COORD(Ped ped, float* coords) { static tGET_PED_LAST_WEAPON_IMPACT_COORD oGET_PED_LAST_WEAPON_IMPACT_COORD = (tGET_PED_LAST_WEAPON_IMPACT_COORD)(Memory::pattern("48 89 5C 24 ? 57 48 83 EC 20 33 DB 48 8B FA 48 89 5A 04").count(1).get(0).get<void>()); return oGET_PED_LAST_WEAPON_IMPACT_COORD(ped, coords); }
	//
	//48 89 5C 24 ? 57 48 83 EC 20 33 DB 48 8B FA 48 89 5A 04
...
namespace SCRIPT
{
	...
	typedef int(__fastcall* tGET_NUMBER_OF_EVENTS)(BOOL p0);
	static int GET_NUMBER_OF_EVENTS(BOOL p0) { static tGET_NUMBER_OF_EVENTS oGET_NUMBER_OF_EVENTS = (tGET_NUMBER_OF_EVENTS)(Memory::pattern("48 83 EC 28 33 D2 85 C9").count(1).get(0).get<void>()); return oGET_NUMBER_OF_EVENTS(p0); }
	...
	typedef BOOL(__fastcall* tGET_EVENT_DATA)(int eventGroup, int eventIndex, int* argStruct, int argStructSize);
	static BOOL GET_EVENT_DATA(int eventGroup, int eventIndex, int* argStruct, int argStructSize) { static tGET_EVENT_DATA oGET_EVENT_DATA = (tGET_EVENT_DATA)(Memory::pattern("48 89 5C 24 ? 57 48 83 EC 20 49 8B F8 4C 8D 05 ? ? ? ?").count(1).get(0).get<void>()); return oGET_EVENT_DATA(eventGroup, eventIndex, argStruct, argStructSize); }
	...
	typedef BOOL(__fastcall* tTRIGGER_SCRIPT_EVENT)(bool unk0, uint64_t* args, int argCount, int bitFlags);
	static BOOL TRIGGER_SCRIPT_EVENT(bool unk0, uint64_t* args, int argCount, int bitFlags) { static tTRIGGER_SCRIPT_EVENT oTRIGGER_SCRIPT_EVENT = (tTRIGGER_SCRIPT_EVENT)(Memory::pattern("48 8B C4 48 89 58 08 48 89 68 10 48 89 70 18 48 89 78 20 41 56 48 81 EC ? ? ? ? 45 8B F0 41 8B F9").count(1).get(0).get<void>()); return oTRIGGER_SCRIPT_EVENT(unk0, args, argCount, bitFlags); }
...
namespace UI
{
	...
	static int _SET_NOTIFICATION_MESSAGE_CLAN_TAG_2(char* picName1, char* picName2, BOOL flash, int iconType1, char* sender, char* subject, float duration, char* clanTag, int iconType2, int p9) { return invoke<int>(0x531B84E7DA981FB6, picName1, picName2, flash, iconType1, sender, subject, duration, clanTag, iconType2, p9); } // 0x531B84E7DA981FB6 0xDEB491C8
																																																																																	   //static int _DRAW_NOTIFICATIONSteam(BOOL blink, BOOL p1) { return invoke<int>(0x2ED7843F8F801023, blink, p1); } // 0x2ED7843F8F801023 0x08F7AF78
	...
	typedef int(__fastcall* t_DRAW_NOTIFICATION_2)(bool blink, bool p1);
	static int _DRAW_NOTIFICATION_2(bool blink, bool p1) { static t_DRAW_NOTIFICATION_2 o_DRAW_NOTIFICATION_2 = (t_DRAW_NOTIFICATION_2)(Memory::pattern("48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 20 40 8A FA 40 8A F1").count(1).get(0).get<void>()); return o_DRAW_NOTIFICATION_2(blink, p1); }
	...
	typedef BOOL(__fastcall*	tBEGIN_TEXT_COMMAND_DISPLAY_TEXT)(char* text);
	static BOOL BEGIN_TEXT_COMMAND_DISPLAY_TEXT(char* text) { static tBEGIN_TEXT_COMMAND_DISPLAY_TEXT oBEGIN_TEXT_COMMAND_DISPLAY_TEXT = (tBEGIN_TEXT_COMMAND_DISPLAY_TEXT)(Memory::pattern("48 83 EC 28 E8 ? ? ? ? E8 ? ? ? ? 33 C9 48 85 C0").count(1).get(0).get<void>()); return oBEGIN_TEXT_COMMAND_DISPLAY_TEXT(text); }
	typedef BOOL(__fastcall*	tEND_TEXT_COMMAND_DISPLAY_TEXT)(float x, float y);
	static BOOL END_TEXT_COMMAND_DISPLAY_TEXT(float x, float y) { static tEND_TEXT_COMMAND_DISPLAY_TEXT oEND_TEXT_COMMAND_DISPLAY_TEXT = (tEND_TEXT_COMMAND_DISPLAY_TEXT)(Memory::pattern("40 53 48 83 EC 40 0F 29 74 24 ? 0F 29 7C 24 ? 41 8B D8").count(1).get(0).get<void>()); return oEND_TEXT_COMMAND_DISPLAY_TEXT(x, y); }
	...
	static float _END_TEXT_COMMAND_GET_WIDTH(BOOL p0) { return invoke<float>(0x85F061DA64ED2F67, p0); } // 0x85F061DA64ED2F67 0xD12A643A
																										...
																										//typedef float(__fastcall* t_END_TEXT_COMMAND_GET_WIDTH)(BOOL p0);
																										//static float _END_TEXT_COMMAND_GET_WIDTH(BOOL p0) { static t_END_TEXT_COMMAND_GET_WIDTH o_END_TEXT_COMMAND_GET_WIDTH = (t_END_TEXT_COMMAND_GET_WIDTH)(Memory::pattern("40 53 48 81 EC ? ? ? ? 83 3D ? ? ? ? ? 8A D9 0F 57 C0").count(1).get(0).get<void>()); return o_END_TEXT_COMMAND_GET_WIDTH(p0); }
	...
	static int _GET_TEXT_SCREEN_LINE_COUNT(float x, float y) { return invoke<int>(0x9040DFB09BE75706, x, y); } // 0x9040DFB09BE75706 0xAA318785
																											   ...
																											   //typedef int(__fastcall*	t_GET_TEXT_SCREEN_LINE_COUNT)(float x, float y);
																											   //static int _GET_TEXT_SCREEN_LINE_COUNT(float x, float y) { static t_GET_TEXT_SCREEN_LINE_COUNT o_GET_TEXT_SCREEN_LINE_COUNT = (t_GET_TEXT_SCREEN_LINE_COUNT)(Memory::pattern("48 8B C4 48 81 EC ? ? ? ? 0F 29 70 E8 0F 29 78 D8 33 C0").count(1).get(0).get<void>()); return o_GET_TEXT_SCREEN_LINE_COUNT(x, y); }
...
namespace GRAPHICS
{
	...
	static BOOL HAS_STREAMED_TEXTURE_DICT_LOADED(const char* textureDict) { return invoke<BOOL>(0x0145F696AAAAD2E4, textureDict); } // 0x0145F696AAAAD2E4 0x3F436EEF
																																	...
																																	//typedef BOOL(__fastcall* tHAS_STREAMED_TEXTURE_DICT_LOADED)(const char* textureDict);
																																	//static BOOL HAS_STREAMED_TEXTURE_DICT_LOADED(const char* textureDict) { static tHAS_STREAMED_TEXTURE_DICT_LOADED oHAS_STREAMED_TEXTURE_DICT_LOADED = (tHAS_STREAMED_TEXTURE_DICT_LOADED)(Memory::pattern("48 83 EC 28 4C 8B C1 48 8D 54 24 ? 48 8D 0D ? ? ? ? E8 ? ? ? ? 83 7C 24 ? ?").count(1).get(0).get<void>()); return oHAS_STREAMED_TEXTURE_DICT_LOADED(textureDict); }
	...
	static void SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED(char* textureDict) { invoke<Void>(0xBE2CACCF5A8AA805, textureDict); } // 0xBE2CACCF5A8AA805 0xF07DDA38
																																	//static void DRAW_RECTSteam(float x, float y, float width, float height, int r, int g, int b, int a) { invoke<Void>(0x3A618A217E5154F0, x, y, width, height, r, g, b, a); } // 0x3A618A217E5154F0 0xDD2BFC77
	typedef void(__fastcall* tDRAW_RECT)(float x, float y, float width, float height, int r, int g, int b, int a);
	static void DRAW_RECT(float x, float y, float width, float height, int r, int g, int b, int a) { static tDRAW_RECT oDRAW_RECT = (tDRAW_RECT)(Memory::pattern("48 8B C4 48 89 58 08 57 48 83 EC 70 48 63 0D ? ? ? ?").count(1).get(0).get<void>()); return oDRAW_RECT(x, y, width, height, r, g, b, a); }
	...
	static float _GET_ASPECT_RATIO(BOOL b) { return invoke<float>(0xF1307EF624A80D87, b); } // 0xF1307EF624A80D87
																							...
																							//typedef float(__fastcall* t_GET_ASPECT_RATIO)(BOOL b);
																							//static float _GET_ASPECT_RATIO(BOOL b) { static t_GET_ASPECT_RATIO o_GET_ASPECT_RATIO = (t_GET_ASPECT_RATIO)(Memory::pattern("48 8B C4 53 48 81 EC ? ? ? ? 0F 29 70 E8 0F 29 78 D8 8B 05 ? ? ? ?").count(1).get(0).get<void>()); return o_GET_ASPECT_RATIO(b); }
	...
	typedef int(__fastcall* tREQUEST_SCALEFORM_MOVIE)(char* scaleformName);
	static int REQUEST_SCALEFORM_MOVIE(char* scaleformName) { static tREQUEST_SCALEFORM_MOVIE oREQUEST_SCALEFORM_MOVIE = (tREQUEST_SCALEFORM_MOVIE)(Memory::pattern("48 8B C4 48 89 58 10 48 89 70 18 48 89 78 20 55 48 8D 68 A1 48 81 EC ? ? ? ? F3 0F 10 45 ?").count(1).get(0).get<void>()); return oREQUEST_SCALEFORM_MOVIE(scaleformName); }
	...
	typedef void(__fastcall* tDRAW_SCALEFORM_MOVIE)(int scaleformHandle, float x, float y, float width, float height, int red, int green, int blue, int alpha, int unk);
	static void DRAW_SCALEFORM_MOVIE(int scaleformHandle, float x, float y, float width, float height, int red, int green, int blue, int alpha, int unk) { static tDRAW_SCALEFORM_MOVIE oDRAW_SCALEFORM_MOVIE = (tDRAW_SCALEFORM_MOVIE)(Memory::pattern("48 8B C4 48 89 58 08 48 89 68 10 48 89 70 18 57 48 81 EC ? ? ? ? 0F 29 70 E8 0F 29 78 D8 44 0F 29 40 ? 48 63 F9").count(1).get(0).get<void>()); return oDRAW_SCALEFORM_MOVIE(scaleformHandle, x, y, width, height, red, green, blue, alpha, unk); }
	...
	typedef BOOL(__fastcall* tBEGIN_SCALEFORM_MOVIE_METHOD)(int scaleform, char* functionName);
	static BOOL BEGIN_SCALEFORM_MOVIE_METHOD(int scaleform, char* functionName) { static tBEGIN_SCALEFORM_MOVIE_METHOD oBEGIN_SCALEFORM_MOVIE_METHOD = (tBEGIN_SCALEFORM_MOVIE_METHOD)(Memory::pattern("40 53 48 83 EC 20 45 33 C0 4C 8B DA").count(1).get(0).get<void>()); return oBEGIN_SCALEFORM_MOVIE_METHOD(scaleform, functionName); }
	...
	typedef void(__fastcall* tEND_SCALEFORM_MOVIE_METHOD)();
	static void END_SCALEFORM_MOVIE_METHOD() { static tEND_SCALEFORM_MOVIE_METHOD oEND_SCALEFORM_MOVIE_METHOD = (tEND_SCALEFORM_MOVIE_METHOD)(Memory::pattern("40 53 48 83 EC 20 E8 ? ? ? ? 48 8B D8 48 85 C0 74 19 4C 8B 00 8B 15 ? ? ? ? 48 8B C8 41 FF 50 08 84 C0 74 05 48 8B C3 EB 02 33 C0 48 83 C4 20 5B C3 48 89 5C 24 ? 45 33 C9").count(1).get(0).get<void>()); return oEND_SCALEFORM_MOVIE_METHOD(); }
...
namespace STATS
{
	...
	//typedef BOOL(__fastcall* tSTAT_SET_FLOAT)(Hash statName, float value, BOOL save);
	//static BOOL STAT_SET_FLOAT(Hash statName, float value, BOOL save) { static tSTAT_SET_FLOAT oSTAT_SET_FLOAT = (tSTAT_SET_FLOAT)(Memory::pattern("48 89 5C 24 ? F3 0F 11 4C 24 ? 57 48 83 EC 40").count(1).get(0).get<void>()); return oSTAT_SET_FLOAT(statName, value, save); }
	//static BOOL STAT_SET_FLOAT(Hash statName, float value, BOOL save) { static tSTAT_SET_FLOAT oSTAT_SET_FLOAT = (tSTAT_SET_FLOAT)(Memory::pattern("48 89 5C 24 ? F3 0F 11 4C 24 ? 57 48 83 EC 40").count(1).get(0).get<void>()); return oSTAT_SET_FLOAT(statName, value, save); }
	//typedef BOOL(__fastcall* tSTAT_SET_BOOL)(Hash statName, BOOL value, BOOL save);
	//static BOOL STAT_SET_BOOL(Hash statName, BOOL value, BOOL save) { static tSTAT_SET_BOOL oSTAT_SET_BOOL = (tSTAT_SET_BOOL)(Memory::pattern("48 89 5C 24 ? 88 54 24 10 57 48 83 EC 40").count(1).get(0).get<void>()); return oSTAT_SET_BOOL(statName, value, save); }
...
namespace CONTROLS
{
	...
	typedef BOOL(__fastcall* tIS_DISABLED_CONTROL_PRESSED)(int inputGroup, int control);
	static BOOL IS_DISABLED_CONTROL_PRESSED(int inputGroup, int control) { static tIS_DISABLED_CONTROL_PRESSED oIS_DISABLED_CONTROL_PRESSED = (tIS_DISABLED_CONTROL_PRESSED)(Memory::pattern("40 53 48 83 EC 20 48 8B 05 ? ? ? ? 8B DA 48 85 C0 74 10 80 78 14 00 75 06 83 78 04 00 74 04 32 C0 EB 4F 48 8B 05 ? ? ? ? 48 89 44 24 ? 48 C1 E8 20 83 C8 08 89 44 24 44 85 C9 75 09 33 C9").count(1).get(0).get<void>()); return oIS_DISABLED_CONTROL_PRESSED(inputGroup, control); }
...
namespace FIRE
{
	...
	static BOOL GET_CLOSEST_FIRE_POS(Vector3* outPosition, float x, float y, float z) { return invoke<BOOL>(0x352A9F6BCF90081F, outPosition, x, y, z); } // 0x352A9F6BCF90081F 0xC4977B47
																																						 //typedef BOOL(__fastcall* tADD_EXPLOSIONSteam)(Vector3* pos, int type, float damage, bool audible, bool invis, float shake, bool nodmg);
																																						 //static BOOL ADD_EXPLOSIONSteam(Vector3* pos, int type, float damage, bool audible, bool invis, float shake, bool nodmg) { static tADD_EXPLOSIONSteam oADD_EXPLOSIONSteam = (tADD_EXPLOSIONSteam)(Memory::pattern("48 89 5C 24 ? 48 89 6C 24 ? 48 8D 64 24 ? 48 8D 6C 24 ? 48 81 EC ? ? ? ? F3 0F 10 01").count(1).get(0).get<void>()); return oADD_EXPLOSIONSteam(pos, type, damage, audible, invis, shake, nodmg); }
																																						 //	typedef BOOL(__fastcall* tADD_EXPLOSION)(Vector3* pos, int type, float damage, bool audible, bool invis, float shake, bool nodmg);
																																						 //static BOOL ADD_EXPLOSION(Vector3* pos, int type, float damage, bool audible, bool invis, float shake, bool nodmg) { static tADD_EXPLOSION oADD_EXPLOSION = (tADD_EXPLOSION)(Memory::pattern("48 89 5C 24 ? 48 8D 64 24 ? 48 89 2C 24 48 8D 6C 24 ? 48 81 EC ? ? ? ? F3 0F 10 01").count(1).get(0).get<void>()); return oADD_EXPLOSION(pos, type, damage, audible, invis, shake, nodmg); }
	static void ADD_EXPLOSION(float x, float y, float z, int type, float damage, bool audible, bool invis, float shake, bool nodmg) { invoke<Void>(0xE3AD2BDBAEE269AC, x, y, z, type, damage, audible, invis, shake, nodmg); } // 0xE3AD2BDBAEE269AC 0x10AF5258
...
namespace NETWORK
{
	...
	//typedef BOOL(__fastcall* tNETWORK_IS_SESSION_STARTED)();
	//static BOOL NETWORK_IS_SESSION_STARTED() { static tNETWORK_IS_SESSION_STARTED oNETWORK_IS_SESSION_STARTED = (tNETWORK_IS_SESSION_STARTED)(Memory::pattern("48 8B 0D ? ? ? ? 33 C0 48 85 C9 74 0E 83 B9 ? ? ? ? ? 75 05").count(1).get(0).get<void>()); return oNETWORK_IS_SESSION_STARTED(); }
	...
	typedef int(__fastcall* tNETWORK_GET_NETWORK_ID_FROM_ENTITY)(Entity entity);
	static int NETWORK_GET_NETWORK_ID_FROM_ENTITY(Entity entity) { static tNETWORK_GET_NETWORK_ID_FROM_ENTITY oNETWORK_GET_NETWORK_ID_FROM_ENTITY = (tNETWORK_GET_NETWORK_ID_FROM_ENTITY)(Memory::pattern("48 89 5C 24 ? 57 48 83 EC 20 E8 ? ? ? ? 33 DB 48 8B F8 48 85 C0 74 16").count(1).get(0).get<void>()); return oNETWORK_GET_NETWORK_ID_FROM_ENTITY(entity); }
	...
	typedef bool(__fastcall* tNETWORK_REQUEST_CONTROL_OF_ENTITY)(Entity entity);
	static bool NETWORK_REQUEST_CONTROL_OF_ENTITY(Entity entity) { static tNETWORK_REQUEST_CONTROL_OF_ENTITY oNETWORK_REQUEST_CONTROL_OF_ENTITY = (tNETWORK_REQUEST_CONTROL_OF_ENTITY)(Memory::pattern("48 89 5C 24 ? 57 48 83 EC 20 8B D9 E8 ? ? ? ? 84 C0").count(1).get(0).get<void>()); return oNETWORK_REQUEST_CONTROL_OF_ENTITY(entity); }
	...
	typedef void(__fastcall* tSET_NETWORK_ID_CAN_MIGRATE)(int netId, BOOL toggle);
	static void SET_NETWORK_ID_CAN_MIGRATE(int netId, BOOL toggle) { static tSET_NETWORK_ID_CAN_MIGRATE oSET_NETWORK_ID_CAN_MIGRATE = (tSET_NETWORK_ID_CAN_MIGRATE)(Memory::pattern("85 C9 0F 8E ? ? ? ? 48 89 5C 24 ? 57 48 83 EC 20 8A DA").count(1).get(0).get<void>()); return oSET_NETWORK_ID_CAN_MIGRATE(netId, toggle); }
	...
	typedef int(__fastcall* tGET_NETWORK_TIME)();
	static int GET_NETWORK_TIME() { static tGET_NETWORK_TIME oGET_NETWORK_TIME = (tGET_NETWORK_TIME)(Memory::pattern("40 53 48 83 EC 20 48 8B 0D ? ? ? ? E8 ? ? ? ? 84 C0 74 19").count(1).get(0).get<void>()); return oGET_NETWORK_TIME(); }
	...
	typedef void(__fastcall* tNETWORK_ADD_PED_TO_SYNCHRONISED_SCENE)(Ped ped, int netScene, char* animDict, char* animnName, float speed, float speedMultiplier, int duration, int flag, float playbackRate, Any p9);
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Ped ped, int netScene, char* animDict, char* animnName, float speed, float speedMultiplier, int duration, int flag, float playbackRate, Any p9) { static tNETWORK_ADD_PED_TO_SYNCHRONISED_SCENE oNETWORK_ADD_PED_TO_SYNCHRONISED_SCENE = (tNETWORK_ADD_PED_TO_SYNCHRONISED_SCENE)(Memory::pattern("48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 50 49 8B D9").count(1).get(0).get<void>()); return oNETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(ped, netScene, animDict, animnName, speed, speedMultiplier, duration, flag, playbackRate, p9); }
	...
	typedef void(__fastcall* tNETWORK_START_SYNCHRONISED_SCENE)(int netScene);
	static void NETWORK_START_SYNCHRONISED_SCENE(int netScene) { static tNETWORK_START_SYNCHRONISED_SCENE oNETWORK_START_SYNCHRONISED_SCENE = (tNETWORK_START_SYNCHRONISED_SCENE)(Memory::pattern("48 83 EC 68 83 64 24 ? ? 83 64 24 ? ? 8A 84 24 ? ? ? ?").count(1).get(0).get<void>()); return oNETWORK_START_SYNCHRONISED_SCENE(netScene); }
...
namespace DLC2
{
	//static BOOL IS_DLC_PRESENT(Hash dlcHash) { return invoke<BOOL>(0x812595A0644CE1DE, dlcHash); } // 0x812595A0644CE1DE 0x1F321943 48 89 5C 24 ? 57 48 83 EC 20 81 F9 ? ? ? ?
	typedef BOOL(__fastcall* tIS_DLC_PRESENT)(Hash dlcHash);
	static BOOL IS_DLC_PRESENT(Hash dlcHash) { static tIS_DLC_PRESENT oIS_DLC_PRESENT = (tIS_DLC_PRESENT)(Memory::pattern("48 89 5C 24 ? 57 48 83 EC 20 81 F9 ? ? ? ?").count(1).get(0).get<void>()); return oIS_DLC_PRESENT(dlcHash); }
...
namespace DECORATOR
{
	...
	static BOOL _DECOR_SET_FLOAT(Entity entity, char* propertyName, float value) { return invoke<BOOL>(0x211AB1DD8D0F363A, entity, propertyName, value); } // 0x211AB1DD8D0F363A
																																						   //static BOOL DECOR_SET_INTSteam(Entity entity, char* propertyName, int value) { return invoke<BOOL>(0x0CE3AA5E1CA19E10, entity, propertyName, value); } // 0x0CE3AA5E1CA19E10 0xDB718B21
	typedef BOOL(__fastcall* tDECOR_SET_INT)(Entity entity, char* propertyName, int value);
	static BOOL DECOR_SET_INT(Entity entity, char* propertyName, int value) { static tDECOR_SET_INT oDECOR_SET_INT = (tDECOR_SET_INT)(Memory::pattern("48 89 5C 24 ? 44 89 44 24 ? 57 48 83 EC 20 48 8B FA E8 ? ? ? ? 48 8B D8 48 85 C0 74 22 48 8B D7 33 C9 E8 ? ? ? ? 4C 8D 44 24 ? 48 8D 54 24 ? 48 8B CB 89 44 24 48 E8 ? ? ? ? B0 01").count(1).get(0).get<void>()); return oDECOR_SET_INT(entity, propertyName, value); }
	...
	typedef void(__fastcall* tDECOR_REGISTER)(char* propertyName, int type);
	static void DECOR_REGISTER(char* propertyName, int type) { static tDECOR_REGISTER oDECOR_REGISTER = (tDECOR_REGISTER)(Memory::pattern("40 53 48 83 EC 20 80 3D ? ? ? ? ? 8B DA 75 29").count(1).get(0).get<void>()); return oDECOR_REGISTER(propertyName, type); }
...
namespace UNK3
{
	...
	static Any _0x3C4487461E9B0DCB() { return invoke<Any>(0x3C4487461E9B0DCB); } // 0x3C4487461E9B0DCB //THIS ONE
	...
	static int _0x74A0FD0688F1EE45(int p0) { return invoke<int>(0x74A0FD0688F1EE45, p0); } // 0x74A0FD0688F1EE45 //randy?
	...
	static BOOL _NETWORK_SHOP_CHECKOUT_START(Any p0) { return invoke<BOOL>(0x39BE7CEA8D9CC8E6, p0); } // 0x39BE7CEA8D9CC8E6
																									  //typedef BOOL(__fastcall* t_NETWORK_SHOP_CHECKOUT_START)(Any p0);
																									  //static BOOL _NETWORK_SHOP_CHECKOUT_START(Any p0) { static t_NETWORK_SHOP_CHECKOUT_START o_NETWORK_SHOP_CHECKOUT_START = (t_NETWORK_SHOP_CHECKOUT_START)(Memory::pattern("48 83 EC 28 E8 ? ? ? ? 33 C9 48 85 C0 74 0C").count(1).get(0).get<void>()); return o_NETWORK_SHOP_CHECKOUT_START(p0); }

	static BOOL _NETWORK_SHOP_BEGIN_SERVICE(Any* value, Any p1, Any p2, Any p3, Any p4, int p5) { return invoke<BOOL>(0x3C5FD37B5499582E, value, p1, p2, p3, p4, p5); } // 0x3C5FD37B5499582E
																																										//typedef BOOL(__fastcall* t_NETWORK_SHOP_BEGIN_SERVICE)(DWORD* value, Any p1, Any p2, Any p3, Any p4, int p5);
																																										//static BOOL _NETWORK_SHOP_BEGIN_SERVICE(DWORD* value, int p1, int p2, int p3, int p4, int p5) { static t_NETWORK_SHOP_BEGIN_SERVICE o_NETWORK_SHOP_BEGIN_SERVICE = (t_NETWORK_SHOP_BEGIN_SERVICE)(Memory::pattern("48 85 5C 26 ? 48 82 6C 28 ? 48 89 74 24 ? 57 41 52 41 57 48 83 EC 50 45 8B F1").count(1).get(0).get<void>()); return o_NETWORK_SHOP_BEGIN_SERVICE(value, p1, p2, p3, p4, p5); }
	...
	static Any _0x23789E777D14CE44() { return invoke<Any>(0x23789E777D14CE44); } // 0x23789E777D14CE44G
